...
Public Class CustomerInfo
    ...
    Private _cust_NTNNumber As String 'CR # 346
    Private _Cust_STRNumber As String 'CR # 346
    ...
    'CR # 346
    Public Property cust_NTNNumber() As String
        Get
            Return _cust_NTNNumber
        End Get
        Set(ByVal value As String)
            _cust_NTNNumber = value
        End Set
    End Property
    'CR # 346
    Public Property cust_STRNumber() As String
        Get
            Return _Cust_STRNumber
        End Get
        Set(ByVal value As String)
            _Cust_STRNumber = value
        End Set
    End Property
End Class
