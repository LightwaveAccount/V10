...
#Region "Public Functions and Procedures"
    ...
    Public Shared Function GetAccountDetail(ByVal key As String, ByVal ObjDataTable As DataTable) As String
        ...
        Try
            ...
            Dim ObjDataView As DataView = GetFilterDataFromDataTable(ObjDataTable, " AccountID = '" & key & "'")
    ...
    Public Function Update(ByVal SysConfig As SystemConfiguration) As Boolean
        ...
        Try
            ...
            'CR # 164
            ' SQL Statement Log ..
            objModelTemp.ActivityLog.SQLType = "UPDATE"
            objModelTemp.ActivityLog.TableName = "tblGLConfiguration"
            objModelTemp.ActivityLog.SQL = strSQL
            UtilityDAL.BuildSQLLog(objModelTemp.ActivityLog, trans, True)


            ' Activity Log ..
            objModelTemp.ActivityLog.FormAction = "Update"
            UtilityDAL.BuildActivityLog(objModelTemp.ActivityLog, trans)
            ' Commit Transaction .. 
            trans.Commit()
