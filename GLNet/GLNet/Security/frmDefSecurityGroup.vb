...
''// Description     : this form is used to defin secuirty rights against the selected group and categories
''//                   in the system.                         
''// Function List   : 								                                    
''//											                                            
''//-------------------------------------------------------------------------------------
...
#Region "Interface Methods"
    ...
    Public Function IsValidate(Optional ByVal Mode As EnumDataMode = EnumDataMode.Disabled, Optional ByVal Condition As String = "") As Boolean Implements IGeneral.IsValidate
        ...
        Try
            ...
            If Condition = "BackEndValidation" Then
                Call New GroupDAL().IsValidateForDelete(mobjModel)
                Return True
            End If
    ...
    Public Function Delete(Optional ByVal Condition As String = "") As Boolean Implements IGeneral.Delete
        Try
            ...
            If Not Me.IsValidate(EnumDataMode.[New], "BackEndValidation") Then Exit Function
...
#Region "Form Controls Events"
    ...
    Private Sub frmDefCity_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Call ReSetControls()
            AddHandler grdAllRecords.SelectionChanged, AddressOf grdAllRecords_SelectionChanged
    ...
    Private Sub grdAllRecords_LoadingRow(ByVal sender As Object, ByVal e As Janus.Windows.GridEX.RowLoadEventArgs) Handles grdAllRecords.LoadingRow
        ...
        Try
            ...
            If e.Row.RowType = Janus.Windows.GridEX.RowType.TotalRow Then
                ...
                e.Row.Cells(EnumGridSecurityGroup.GroupName).Text = strTotalRecords & " (" & Me.grdAllRecords.GetTotal(Me.grdAllRecords.RootTable.Columns(EnumGridSecurityGroup.GroupName), Janus.Windows.GridEX.AggregateFunction.Count) & ") "
