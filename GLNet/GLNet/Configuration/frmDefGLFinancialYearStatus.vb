...
''//------------------------------------------------------------------------------------
''   27 Jan,2011       Abdul Jabbar         Financial Year Status form generates error when Fyear Status updated
...
''/////////////////////////////////////////////////////////////////////////////////////////
Public Class frmDefGLFinancialYearStatus
...
#Region "Variables"
    ...
    Private mobjModel As FiniancialYearStatus

    Private StartDate As DateTime
    Private EndDate As DateTime
    Private intPkId As Integer
    Private AllowCompanySelection As Boolean = False
...
#Region "Interface Methods"
    ...
    Public Sub GetAllRecords(Optional ByVal Condition As String = "") Implements IGeneral.GetAllRecords
        ...
        Try
            ...
            Dim dt As DataTable = New FinancialYearStatusDal().GetAll(Me.cmbCompany.SelectedValue)
    ...
    Public Function IsValidate(Optional ByVal Mode As EnumDataMode = EnumDataMode.Disabled, Optional ByVal Condition As String = "") As Boolean Implements IGeneral.IsValidate
        ...
        Try
            ...
            'If Not Me.grdAllRecords.RowCount > 0 Then
            '    ShowErrorMessage("No record found in the grid")
            '    Return False
            If Me.ComboBox1.Text = Me.grdAllRecords.GetRow.Cells(EnumGridFYear.Status).Text Then
                ShowErrorMessage("Change status First")
                GridEX1_SelectionChanged(Nothing, Nothing)
                Return False
            ElseIf intPkId = gObjFinancialYearInfo.FYearID Then
                ShowErrorMessage("Can't close user'login year")
                Return False
            ElseIf Not Val(G_PROFIT_LOSS_ACC_ID) > 0 Then
                ShowErrorMessage("Profit and Loss account is not configured")
                Return False
            End If

            If New FinancialYearStatusDal().IsLatestYear(Me.intPkId) = True And Me.ComboBox1.Text = "Closed" Then
                ShowErrorMessage("Open New Year Before Closing Last Year")
                Return False
            End If

            Return New FinancialYearStatusDal().IsValidateForUpdate(mobjModel)
            Return True
    ...
    Public Sub FillModel(Optional ByVal Condition As String = "") Implements IGeneral.FillModel
        ...
        Try
            ...
            ''Create Model object
            mobjModel = New FiniancialYearStatus
            With mobjModel
                .FYearID = intPkId
                .StartDate = Me.dtpStartDate.Value
                .EndDate = Me.dtpEndDate.Value
                .YearCode = Me.txtFYearCode.Text
                .Status = Me.ComboBox1.Text
                .LocationID = Me.cmbCompany.SelectedValue
                .OldStatus = Me.grdAllRecords.GetRow.Cells(EnumGridFYear.Status).Text.Trim
        ...
        Try
            ...
            If Me.IsValidate(EnumDataMode.[New]) Then
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    If New FinancialYearStatusDal().Update(Me.mobjModel) Then
                        'change by Farooq-H  CR# 254 
                        If Me.mobjModel.Status = "Closed" Then
                            mObjSMS.SendSMS(EnumSMSCodes.SMS_FYS_CL_01.ToString, "&ParamYearCode&=" & Me.mobjModel.YearCode & ";&StartDate&=" & Me.mobjModel.StartDate.ToString & ";&StartDate&=" & Me.mobjModel.StartDate.ToString & ";&EndDate&=" & Me.mobjModel.EndDate.ToString & ";&Status&=" & Me.mobjModel.Status.ToString & " ")
                        ElseIf Me.mobjModel.Status = "Open" Then
                            mObjSMS.SendSMS(EnumSMSCodes.SMS_FYS_OP_01.ToString, "&ParamYearCode&=" & Me.mobjModel.YearCode & ";&StartDate&=" & Me.mobjModel.StartDate.ToString & ";&StartDate&=" & Me.mobjModel.StartDate.ToString & ";&EndDate&=" & Me.mobjModel.EndDate.ToString & ";&Status&=" & Me.mobjModel.Status.ToString & " ")
                        End If
                        ...
                        Me.GridEX1_SelectionChanged(Me, Nothing)
        ...
        Try
            ...
            If Me.IsValidate(, "BackEndDeleteValidation") Then
                ...
                If result = Windows.Forms.DialogResult.Yes Then
                    ...
                    If New FinancialYearStatusDal().Deleted(Me.mobjModel) Then
...
#Region "Form Controls Events"
    ...
    Private Sub dtpEndDate_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtpEndDate.LostFocus
        ...
        Try
            ...
            lblFYear.Text = dtStartDate.Year & "-" & dtEndDate.Year
    ...
    Private Sub dtpStartDate_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtpStartDate.LostFocus
        ...
        Try
            ...
            Me.lblFYear.Text = DtStartdate.Year & "-" & DtEndDate.Year
    ...
    Private Sub GridEX1_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles GridEX1.SelectionChanged
        Try
            ...
            Me.ComboBox1.Text = Me.grdAllRecords.GetValue(EnumGridFYear.Status).ToString
    ...
    Private Sub cmbCompany_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCompany.SelectedIndexChanged
        If Me.AllowCompanySelection = False Then Exit Sub
        Me.GetAllRecords()
